...
const ArmorScreen = ({ route }) => {
  const navigation = useNavigation();
  const { title, image, commentsScreen } = route.params; // 🔥 Modular Props
    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        <View style={styles.headerContainer}>
          ...
          <TouchableOpacity style={styles.commentButton} onPress={() => navigation.navigate(commentsScreen)}>
        ...
        <View style={styles.imageContainer}>
          <Image source={image} style={styles.armorImage} />
        </View>

        {/* About Section */}
        <View style={styles.aboutSection}>
          <Text style={styles.aboutHeader}>About {title}</Text>
          <Text style={styles.aboutText}>
            {title} is a legendary armor piece designed for both agility and resilience. 
            It is crafted with a fusion of advanced technology and ancient craftsmanship, 
