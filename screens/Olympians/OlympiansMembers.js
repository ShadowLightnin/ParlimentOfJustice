...
const characterImages = {
  ...
  Dakota: require('../../assets/Armor/DakotaPlaceHolder.jpg'),
  Laura: require('../../assets/Armor/LauraPlaceHolder.jpg'),
  Waine: require('../../assets/Armor/WainePlaceHolder.jpg'),
  Elizabeth: require('../../assets/Armor/ElizabethPlaceHolder.jpg'),
  Christopher: require('../../assets/Armor/ChristopherPlaceHolder.jpg'),
  ...
  Addie: require('../../assets/Armor/AddiePlaceHolder.jpg'),
  Matt: require('../../assets/Armor/MattPlaceHolder.jpg'),
  Jessica: require('../../assets/Armor/JessicaCPlaceHolder.jpg'),
  ...
  Mikie: require('../../assets/Armor/MikiePlaceHolder.jpg'),
  Prairie: require('../../assets/Armor/PrairiePlaceHolder.jpg'),
  'Ryan kid': require('../../assets/Armor/RyanKidPlaceHolder.jpg'),
  Chad: require('../../assets/Armor/ChadPlaceHolder.jpg'),
  Rachel: require('../../assets/Armor/RachelPlaceHolder.jpg'),
  ...
  Gary: require('../../assets/Armor/GaryPlaceHolder.jpg'),
  ...
  'Great Grandma Parker': require('../../assets/Armor/ParkerPlaceHolder.jpg'),
