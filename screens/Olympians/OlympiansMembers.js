...
const familyData = [
  {
    family: 'Parents',
    members: [
      { name: 'Angela', codename: '', screen: '' },
      { name: 'Todd', codename: '', screen: '' },
    ],
  },
  {
    family: 'Jensen',
    members: [
      { name: 'Savannah', codename: '', screen: '' },
      { name: 'Lee', codename: '', screen: '' },
      { name: 'Emilee', codename: '', screen: '' },
      { name: 'Samantha', codename: '', screen: '' },
      { name: 'Ella', codename: '', screen: '' },
    ],
  },
  {
    family: 'McNeil',
    members: [
      { name: 'Mary', codename: '', screen: '' },
      { name: 'Chance', codename: '', screen: '' },
      { name: 'Ava', codename: '', screen: '' },
      { name: 'Charlie', codename: '', screen: '' },
    ],
  },
  {
    family: 'Briggs',
    members: [
      { name: 'Heather S', codename: '', screen: '' },
      { name: 'Bobby', codename: '', screen: '' },
      { name: 'Ammon', codename: '', screen: '' },
      { name: 'Piper', codename: '', screen: '' },
    ],
  },
  {
    family: 'Bolander',
    members: [
      { name: 'Annie', codename: '', screen: '' },
      { name: 'Paul', codename: '', screen: '' },
      { name: 'McKinley', codename: '', screen: '' },
      { name: 'Whitney', codename: '', screen: '' },
      { name: 'Vinson', codename: '', screen: '' },
    ],
  },
  {
    family: 'Stillman',
    members: [
      { name: 'Wesley', codename: '', screen: '' },
      { name: 'Melissa', codename: '', screen: '' },
      { name: 'Jackson', codename: '', screen: '' },
      { name: 'Mason', codename: '', screen: '' },
      { name: 'Rylie', codename: '', screen: '' },
      { name: 'Sammy', codename: '', screen: '' },
    ],
  },
  {
    family: 'Stillman',
    members: [
      { name: 'David', codename: '', screen: '' },
      { name: 'Isaydy', codename: '', screen: '' },
      { name: 'Darron', codename: '', screen: '' },
      { name: 'Isabel', codename: '', screen: '' },
    ],
  },
  {
    family: 'Stillman',
    members: [
      { name: 'Gary jr', codename: '', screen: '' },
      { name: 'Sarah', codename: '', screen: '' },
      { name: 'Josh', codename: '', screen: '' },
      { name: 'Garden', codename: '', screen: '' },
      { name: 'Sophia', codename: '', screen: '' },
      { name: 'Paisley', codename: '', screen: '' },
      { name: 'Ellie', codename: '', screen: '' },
    ],
  },
  {
    family: 'Cummings',
    members: [
      { name: 'Sean', codename: '', screen: '' },
      { name: 'Heather C', codename: '', screen: '' },
      { name: 'Brett small', codename: '', screen: '' },
      { name: 'Jake', codename: '', screen: '' },
      { name: 'Ailey', codename: '', screen: '' },
      { name: 'Aubrey', codename: '', screen: '' },
      { name: 'James', codename: '', screen: '' },
    ],
  },
  {
    family: 'Cummings',
    members: [
      ...
      { name: 'Maren', codename: '', screen: '' },
      { name: 'Sasha', codename: '', screen: '' },
      { name: 'Ian', codename: '', screen: '' },
      { name: 'Riker', codename: '', screen: '' },
      { name: 'Dakota', codename: '', screen: '' },
    ],
  },
  {
    family: 'Cummings',
    members: [
      { name: 'Lora', codename: '', screen: '' },
      { name: 'Wayne', codename: '', screen: '' },
      { name: 'Elizabeth', codename: '', screen: '' },
      { name: 'Christopher', codename: '', screen: '' },
      { name: 'Tom', codename: '', screen: '' },
    ],
  },
  {
    family: 'Cummings',
    members: [
      { name: 'Brett', codename: '', screen: '' },
      { name: 'Angie', codename: '', screen: '' },
      { name: 'Bryce', codename: '', screen: '' },
      { name: 'Lillie', codename: '', screen: '' },
  ...
  },
  {
    family: 'Cummings',
    members: [
      { name: 'Matt', codename: '', screen: '' },
      { name: 'Jessica', codename: '', screen: '' },
      { name: 'Kyle', codename: '', screen: '' },
      { name: 'Daisy', codename: '', screen: '' },
      { name: 'Rose', codename: '', screen: '' },
      { name: 'Mikie', codename: '', screen: '' },
      { name: 'Prairie', codename: '', screen: '' },
      { name: 'Ryan kid', codename: '', screen: '' },
    ],
  },
  {
    family: 'Cummings',
    members: [
      { name: 'Chad', codename: '', screen: '' },
      { name: 'Rochelle', codename: '', screen: '' },
      { name: 'Annabeth', codename: '', screen: '' },
      { name: 'Levi', codename: '', screen: '' },
  ...
  },
  {
    family: 'Cummings',
    members: [
      { name: 'Troy', codename: '', screen: '' },
    ],
  },
  {
    family: 'Stillman Grandparents',
    members: [
      { name: 'Gary', codename: '', screen: '' },
      { name: 'Jeanine', codename: '', screen: '' },
    ],
  },
  {
    family: 'Cummings Grandparents',
    members: [
      { name: 'Sharrel', codename: '', screen: '' },
      { name: 'Dorthy', codename: '', screen: '' },
  ...
  },
  {
    ...
    members: [
      ...
      { name: 'Kris', codename: 'Aqua Spirit', screen: '' },
      { name: 'Carlo', codename: 'Shadow Flame', screen: '' },
