...
const characterImages = {
  Angela: require('../../assets/Armor/PlaceHolder.jpg'),
  Todd: require('../../assets/Armor/PlaceHolder.jpg'),
  Savanna: require('../../assets/Armor/PlaceHolder.jpg'),
  Lee: require('../../assets/Armor/PlaceHolder.jpg'),
  Emily: require('../../assets/Armor/PlaceHolder.jpg'),
  Samantha: require('../../assets/Armor/PlaceHolder.jpg'),
  Ella: require('../../assets/Armor/PlaceHolder.jpg'),
  Mary: require('../../assets/Armor/PlaceHolder.jpg'),
  Chance: require('../../assets/Armor/PlaceHolder.jpg'),
  Ava: require('../../assets/Armor/PlaceHolder.jpg'),
  Charlie: require('../../assets/Armor/PlaceHolder.jpg'),
  Heather: require('../../assets/Armor/PlaceHolder.jpg'),
  Bobby: require('../../assets/Armor/PlaceHolder.jpg'),
  Ammon: require('../../assets/Armor/PlaceHolder.jpg'),
  Piper: require('../../assets/Armor/PlaceHolder.jpg'),
  Annie: require('../../assets/Armor/PlaceHolder.jpg'),
  Paul: require('../../assets/Armor/PlaceHolder.jpg'),
  McKinley: require('../../assets/Armor/PlaceHolder.jpg'),
  Whitney: require('../../assets/Armor/PlaceHolder.jpg'),
  Vinson: require('../../assets/Armor/PlaceHolder.jpg'),
  Wesley: require('../../assets/Armor/PlaceHolder.jpg'),
  Melisa: require('../../assets/Armor/PlaceHolder.jpg'),
  Jackson: require('../../assets/Armor/PlaceHolder.jpg'),
  Mason: require('../../assets/Armor/PlaceHolder.jpg'),
  Rylie: require('../../assets/Armor/PlaceHolder.jpg'),
  Sammy: require('../../assets/Armor/PlaceHolder.jpg'),
  David: require('../../assets/Armor/PlaceHolder.jpg'),
  Isiade: require('../../assets/Armor/PlaceHolder.jpg'),
  Darron: require('../../assets/Armor/PlaceHolder.jpg'),
  Isabel: require('../../assets/Armor/PlaceHolder.jpg'),
