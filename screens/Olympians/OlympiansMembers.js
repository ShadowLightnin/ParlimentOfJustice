...
const familyData = [
  {
    family: 'Parents',
    members: [
      { name: 'Angela', codename: 'Celestial Guardian', screen: '' },
  ...
  },
  {
    ...
    members: [
      ...
      { name: 'Ammon', codename: 'Valor', screen: '' },
      { name: 'Piper', codename: 'Sylph', screen: '' },
    ],
  },
  {
    family: 'Bolander',
    members: [
      ...
      { name: 'Whitney', codename: 'Lumen Grace', screen: '' },
