    ...
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        <View style={styles.aboutSection}>
          ...
          Jennifer McNeil, known as Kintsugi, is the youngest of the McNeil siblings and a vital member of the Titans within the Parliament of Justice, a woman who has been shattered by loss but reborn stronger through her pain. At 5'8", her presence is both delicate and resolute, her cracked yet golden-mended armor a testament to her resilience. Behind her serene demeanor lies a soul that has fallen from grace, much like her brother Spencer, but where he struggles with nostalgia, Jennifer finds strength in acceptance and healing. She’s married to Myran, whose technological prowess complements her own abilities, and she’s deeply devoted to her brothers, Spencer and Jared, as well as her cousins Ben, Azure, Will, and Emma. Jennifer prefers to mend rather than destroy, drawing inspiration from the beauty of imperfection, but her fallen state leaves her questioning her own worth. Off the battlefield, she’s a nurturer, often found tending to her family’s emotional wounds or crafting art that reflects her journey.          </Text>
          <Text style={styles.aboutText}>
          Backstory
          </Text>
          <Text style={styles.aboutText}>
          Jennifer grew up in the same rugged village as her brothers Spencer and Jared, the youngest McNeil sibling in a family defined by strength and faith. While Spencer led with power and Jared with speed, Jennifer was the heart of the family, her compassion and creativity setting her apart. She was inspired by stories of redemption and renewal, particularly the idea of Kintsugi—turning brokenness into something beautiful with gold. This philosophy became her lifeline when tragedy struck.          </Text>
          <Text style={styles.aboutText}>
          During a devastating raid on their village from Zion City’s Outer Darkness sector, Jennifer witnessed the destruction of everything she held dear—homes burned, families scattered, and her brothers pushed to their limits. In the chaos, she discovered her ability to heal, but the trauma left her spiritually and emotionally broken. Her armor, once pristine, cracked under the weight of her grief, but she refused to let it define her. Drawing on her faith and the support of her brothers and cousins, she mended her armor with gold, embracing her flaws as part of her strength.          </Text>
          <Text style={styles.aboutText}>
          As a Titan, Jennifer stood alongside Spencer and Jared, using her healing to protect their family, including the Briggs (Ben and Azure), Cummings (Will and Emma), and other oldest cousins. But as Zion City’s corruption grew, so did her sense of failure. She felt responsible for not preventing Spencer’s fall or easing Jared’s burden, and her own confidence wavered. Married to Myran, a techno-savvy ally, Jennifer found a partner who helped her see the beauty in her brokenness, but her fallen state—mirrored by Spencer’s—continues to haunt her. Her Kintsugi armor became a symbol of hope, but also a reminder of how far she’s fallen from the healer she once was.          </Text>
          <Text style={styles.aboutText}>
          Abilities          
          </Text>
          <Text style={styles.aboutText}>
          Jennifer’s suit and innate compassion grant her a range of powers focused on healing, protection, and resilience, reflecting her Kintsugi theme:          </Text>
          <Text style={styles.aboutText}>
          Healing Touch: Can mend physical and emotional wounds, restoring health and morale to allies. Her touch leaves a golden glow, symbolizing renewal, but it drains her when she overextends herself.          </Text>
          <Text style={styles.aboutText}>
          Golden Resilience: Her cracked, gold-mended armor absorbs damage and redistributes it as protective energy, making her surprisingly durable despite her fragility. The gold seams glow brighter under stress, enhancing her defenses.          </Text>
          <Text style={styles.aboutText}>
          Empathic Connection: Can sense the pain and needs of others, allowing her to prioritize healing where it’s most needed, but this also makes her vulnerable to their despair.          </Text>
          <Text style={styles.aboutText}>
          Light Projection: Can emit soft, golden light to soothe allies, dispel darkness (literal and metaphorical), and disorient enemies, drawing from The Imagined’s creative energy.          </Text>
          <Text style={styles.aboutText}>
          Restorative Aura: Creates a field around herself that accelerates recovery for her family and teammates, but it weakens if her own resolve falters.          </Text>
          <Text style={styles.aboutText}>
          Personality and Role in the Team          
          </Text>
          <Text style={styles.aboutText}>
          Jennifer is the heart of the Titans, a healer and mediator who tries to mend the fractures within her family and team. Like Spencer, she’s fallen from grace, but where he clings to the past, she embraces her brokenness as a source of strength. Her relationship with Spencer is tender but tense—he sees her as a reminder of what he’s lost, while she sees him as a project to heal. With Jared, she’s protective, worried about the pressure he faces as Spencer’s successor, but she also admires his drive.          </Text>
          <Text style={styles.aboutText}>
          As the youngest McNeil sibling, Jennifer feels a responsibility to her cousins—Ben and Azure (Briggs), Will and Emma (Cummings)—and the broader family, often acting as their emotional anchor. Her marriage to Myran strengthens her, as he helps her see the beauty in her flaws, but her fallen state leaves her questioning whether she can truly lead or heal as she once did.          </Text>
          <Text style={styles.aboutText}>
