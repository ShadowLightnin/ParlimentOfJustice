    ...
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        <View style={styles.aboutSection}>
          ...
          <Text style={styles.aboutText}>
          As the second oldest Briggs sibling, Ben mentors Azure but also learns from her harmony, pushing her to refine her skills while drawing strength from her stability. His cousins—Spencer, Jared, Jennifer, William, and Emma—rely on his defensive capabilities, while he draws inspiration from their diverse strengths. In the broader Parliament of Justice, Ben works closely with strategists like Todd (Cummings) and combatants like Samantha (Jensen’s), using his agility to protect the family’s flanks.          </Text>
          <Text style={styles.aboutText}>
