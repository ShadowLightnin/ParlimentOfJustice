...
const isEmpty = (row, col) => (row === 0 && col === 0) || (row === 0 && col === 1) || (row === 0 && col === 2) || (row === 1 && col === 0) || (row === 1 && col === 2) || (row === 2 && col === 0) || (row === 2 && col === 1) || (row === 2 && col === 2);
    ...
    <ImageBackground source={require('../../assets/26.jpg')} style={styles.background}>
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.headerWrapper}>
          ...
          <Text style={styles.header}>Advanced Spartan 3 Crop</Text>
        </View>
