...
const ship = [
  ...
  { name: 'Whale', screen: '', image: require('../../assets/Starship1.jpg'), clickable: true },
  { name: 'Ecquisitor', screen: '', image: require('../../assets/Starship2.jpg'), clickable: true },
  { name: 'Avenger', screen: '', image: require('../../assets/Starship3.jpg'), clickable: true },
  { name: 'Sky Tear', screen: '', image: require('../../assets/Starship4.jpg'), clickable: true },
  { name: 'Gaullion', screen: '', image: require('../../assets/Starship5.jpg'), clickable: true },
  { name: 'Sovreign', screen: '', image: require('../../assets/Starship6.jpg'), clickable: true },
  { name: 'Reaper', screen: '', image: require('../../assets/Starship7.jpg'), clickable: true },
  { name: 'Ambassador', screen: '', image: require('../../assets/Starship8.jpg'), clickable: true },
  { name: 'Star Hunter', screen: '', image: require('../../assets/Starship9.jpg'), clickable: true },
  { name: 'Solar Ray', screen: '', image: require('../../assets/Starship10.jpg'), clickable: true },
  { name: 'USS Stritan', screen: '', image: require('../../assets/Starship11.jpg'), clickable: true },
  { name: 'USS Elegance', screen: '', image: require('../../assets/Starship12.jpg'), clickable: true },
  { name: 'Basktion', screen: '', image: require('../../assets/Starship13.jpg'), clickable: true },
