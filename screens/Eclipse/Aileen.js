    ...
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        <View style={styles.aboutSection}>
          ...
          <Text style={styles.aboutText}>
          Aileen’s armor and cultural strength grant her a range of powers focused on combat, resilience, and inspiration, reflecting her Filipino heritage:          </Text>
          <Text style={styles.aboutText}>
          Martial Mastery: Expert in Filipino martial arts (Arnis/Kali), wielding her Kampilan blade and Sibat/Arnis sticks with deadly precision, striking fast and adapting to any opponent.          </Text>
          <Text style={styles.aboutText}>
          Ancestral Resilience: Channels the endurance of her warrior ancestors, boosting her stamina and resistance to pain, allowing her to fight through injuries and protect her allies.          </Text>
          <Text style={styles.aboutText}>
          Solar Flare: Can emit a burst of radiant energy inspired by the Philippine flag’s sun, stunning enemies or illuminating dark areas, a nod to her sun & stars motif and cultural pride.          </Text>
          <Text style={styles.aboutText}>
          Battle Rhythm: Moves with a rhythmic flow that enhances her agility and coordination, syncing with William’s stealth to create devastating team attacks, reflecting the grace of Filipino dances like Tinikling.          </Text>
          <Text style={styles.aboutText}>
      ...
      >
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            <Text style={styles.modalTitle}>Aileens's Story</Text>
