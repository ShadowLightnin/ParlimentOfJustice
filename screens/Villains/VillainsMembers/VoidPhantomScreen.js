...
const characters = [
  {
    name: "Void Phantom",
    image: require("../../../assets/Villains/VoidPhantom.jpg"),
    clickable: true,
  },
];

export default function VoidPhantomScreen() {
  ...
  const loadAndPlayTrack = useCallback(
    async (index) => {
      ...
      try {
        ...
        console.error("Failed to play Void Phantom track", e);
        setIsPlaying(false);
      }
    },
      ...
      <View style={styles.overlay}>
        ...
        <ScrollView contentContainerStyle={styles.scrollContainer}>
          ...
          <View style={styles.headerOuter}>
            <View style={styles.headerContainer}>
              ...
              <View style={styles.headerGlass}>
                <Text style={styles.title}>Void Phantom</Text>
                <Text style={styles.subtitle}>Spectral Phase • Dimensional Ruin • Ender Control</Text>
              </View>
            </View>
          </View>
          ...
          <View style={styles.section}>
            <Text style={styles.sectionTitle}>Phantom Gallery</Text>
          ...
          <View style={styles.aboutSection}>
            ...
            <Text style={styles.aboutText}>
              Motivation: Sees Zeke as the last obstacle to absolute command of the Ender dimension — determined to erase
              him and consolidate every gateway, rift, and shadow-route under one will.
            </Text>

            <Text style={styles.aboutText}>
              Powers: Phases into a spectral form and weaponizes dark energy to disrupt Ender abilities — destabilizes
              teleports, blurs spatial anchors, and “misroutes” movement through warped corridors.
            </Text>

            <Text style={styles.aboutText}>
              Weapon: A scythe tuned to dimensional frequencies — tears through portal energy and targets Ender power
              directly, cutting the “connection” instead of the body.
            </Text>
          </View>
        </ScrollView>
      </View>
...
const styles = StyleSheet.create({
  ...
  musicControls: {
    ...
    borderBottomWidth: 1,
    borderBottomColor: "rgba(142, 210, 255, 0.28)", // eerie blue
    shadowColor: "#8ED2FF",
    shadowOpacity: 0.25,
  ...
  trackButton: {
    ...
    borderRadius: 999,
    borderWidth: 1,
    borderColor: "rgba(142, 210, 255, 0.70)",
    backgroundColor: "rgba(12, 14, 18, 0.96)",
    marginRight: 6,
  },
  trackButtonText: { color: "#E8F6FF", fontSize: 14, fontWeight: "bold" },
  trackInfoGlass: {
    flex: 1,
    marginHorizontal: 6,
    paddingVertical: 6,
    ...
    borderWidth: 1,
    borderColor: "rgba(142, 210, 255, 0.40)",
    flexDirection: "row",
    alignItems: "center",
  },
  trackLabel: { color: "rgba(232, 246, 255, 0.70)", fontSize: 11, marginRight: 6 },
  trackTitle: { color: "#E8F6FF", fontSize: 13, fontWeight: "700" },
  musicButton: {
  ...
  musicText: { color: "#E8F6FF", fontWeight: "bold", fontSize: 13 },
  ...
  backButton: {
    ...
    backgroundColor: "rgba(10, 12, 16, 0.95)",
    borderWidth: 1,
    borderColor: "rgba(142, 210, 255, 0.55)",
    marginRight: 10,
  },
  backButtonText: { fontSize: 22, color: "#E8F6FF" },
  headerGlass: {
    flex: 1,
    paddingVertical: 10,
    paddingHorizontal: 16,
    ...
    borderWidth: 1,
    borderColor: "rgba(142, 210, 255, 0.22)",
    shadowColor: "#8ED2FF",
    shadowOpacity: 0.35,
    shadowRadius: 18,
  ...
  section: {
    ...
    borderWidth: 1,
    borderColor: "rgba(142, 210, 255, 0.16)",
  },
  sectionTitle: { fontSize: 18, fontWeight: "800", color: "#E8F6FF", textAlign: "center" },
  sectionDivider: {
    marginTop: 8,
    marginBottom: 10,
    alignSelf: "center",
    ...
    height: 2,
    borderRadius: 999,
    backgroundColor: "rgba(142, 210, 255, 0.75)",
  },
  ...
  card: (isDesktop, w) => ({
    ...
    marginRight: 16,
    borderWidth: 1,
    borderColor: "rgba(142, 210, 255, 0.28)",
  ...
  aboutSection: {
    ...
    borderWidth: 1,
    borderColor: "rgba(142, 210, 255, 0.18)",
  },
  aboutHeader: {
    fontSize: 20,
    fontWeight: "900",
