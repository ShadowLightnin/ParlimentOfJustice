...
// ✅ TEMP: Use Sable tracks so nothing breaks until you add Harbinger audio.
...
export default function HarbingerScreen() {
  ...
  const loadAndPlayTrack = useCallback(
    async (index) => {
      ...
      try {
        ...
        console.error("Failed to play Harbinger track", e);
        setIsPlaying(false);
      }
    },
      ...
      <View style={styles.overlay}>
        ...
        <ScrollView contentContainerStyle={styles.scrollContainer}>
          ...
          <View style={styles.headerOuter}>
            <View style={styles.headerContainer}>
              ...
              <View style={styles.headerGlass}>
                <Text style={styles.title}>Harbinger</Text>
                <Text style={styles.subtitle}>Stealth • Signal Jamming • Predator’s Hunt</Text>
              </View>
            </View>
          </View>
          ...
          <View style={styles.aboutSection}>
            ...
            <Text style={styles.aboutText}>
              Harbinger was once a covert operative—betrayed, erased, and reborn as an underground assassin.
              His suit jams radar, fractures sonar, and projects false signatures to drag targets into a hunt
              they can’t win.
            </Text>

            <Text style={styles.aboutText}>
              Powers: extreme stealth, radar/sonar jamming, full invisibility, false signal echoes.
            </Text>

            <Text style={styles.aboutText}>
              Weapon: retractable wrist blades with venomous energy that can paralyze on contact.
            </Text>
          </View>
        </ScrollView>
      </View>
...
const styles = StyleSheet.create({
  ...
  // ✅ HARBRINGER COLORS: black + purple
  musicControls: {
    flexDirection: "row",
    alignItems: "center",
    paddingVertical: 10,
    ...
    borderBottomWidth: 1,
    borderBottomColor: "rgba(180, 115, 255, 0.35)",
    shadowColor: "#B473FF",
    shadowOpacity: 0.4,
  ...
  trackButton: {
    ...
    borderRadius: 999,
    borderWidth: 1,
    borderColor: "rgba(180, 115, 255, 0.85)",
  ...
  trackInfoGlass: {
    ...
    borderWidth: 1,
    borderColor: "rgba(180, 115, 255, 0.55)",
    flexDirection: "row",
    alignItems: "center",
  },
  ...
  musicButton: {
    ...
    marginHorizontal: 4,
    borderWidth: 1,
    borderColor: "rgba(180, 115, 255, 0.9)",
  },
  musicButtonSecondary: {
    ...
    marginHorizontal: 4,
    borderWidth: 1,
    borderColor: "rgba(180, 115, 255, 0.65)",
  },
  ...
  section: {
    ...
    borderWidth: 1,
    borderColor: "rgba(180, 115, 255, 0.35)",
    shadowColor: "#B473FF",
    shadowOpacity: 0.25,
    shadowRadius: 18,
  ...
  sectionDivider: {
    ...
    height: 2,
    borderRadius: 999,
    backgroundColor: "rgba(180, 115, 255, 0.85)",
  },
  ...
  aboutSection: {
    ...
    borderWidth: 1,
    borderColor: "rgba(180, 115, 255, 0.45)",
    shadowColor: "#B473FF",
    shadowOpacity: 0.25,
    shadowRadius: 22,
