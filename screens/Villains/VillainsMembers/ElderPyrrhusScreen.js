...
// ✅ TEMP TRACKS (safe placeholder). Swap to real Elder Pyrrhus audio later.
const TRACKS = [
  {
    id: "pyrrhus_main",
    label: "Elder Pyrrhus Theme",
    source: require("../../../assets/audio/sableEvilish.m4a"),
  },
  {
    id: "pyrrhus_alt",
    label: "Mountain Spirit Mix",
    source: require("../../../assets/audio/sableEvilish.m4a"),
  },
];
...
export default function ElderPyrrhusScreen() {
  ...
  const loadAndPlayTrack = useCallback(
    async (index) => {
      ...
      try {
        ...
        console.error("Failed to play Elder Pyrrhus track", e);
        setIsPlaying(false);
      }
    },
      ...
      <View style={styles.overlay}>
        ...
        <ScrollView contentContainerStyle={styles.scrollContainer}>
          ...
          <View style={styles.headerOuter}>
            <View style={styles.headerContainer}>
              ...
              <View style={styles.headerGlass}>
                ...
                <Text style={styles.subtitle}>FIRE • STRENGTH • MOUNTAIN SPIRITS</Text>
              </View>
            </View>
          </View>
          ...
          <View style={styles.aboutSection}>
            ...
            <Text style={styles.aboutText}>
              Elder Pyrrhus was a tribal leader cast out for a ruthless doctrine: only the brutal deserve to endure.
              He vanished into the mountains and forged a savage bond with ancient spirits—earning immense strength and
              command over fire. Hearing of Annihilator, Pyrrhus recognizes a rival worth burning down.
            </Text>

            <Text style={styles.aboutText}>
              Powers: mountain-spirit endurance, near-invulnerable brawler strength, and pyromancy fueled by fury and ritual.
            </Text>

            <Text style={styles.aboutText}>
              Symbol: a flaming skull helm—his promise to incinerate “heroism” and prove power is taken, not granted.
            </Text>
          </View>
        </ScrollView>
      </View>
...
const styles = StyleSheet.create({
  ...
  // ✅ ELDER PYRRHUS: charcoal + ember orange + ash-gold
  musicControls: {
    flexDirection: "row",
    alignItems: "center",
    paddingVertical: 10,
    ...
    borderBottomWidth: 1,
    borderBottomColor: "rgba(255, 140, 60, 0.35)",
    shadowColor: "#FF8C3C",
    shadowOpacity: 0.4,
  ...
  trackButton: {
    ...
    borderRadius: 999,
    borderWidth: 1,
    borderColor: "rgba(255, 185, 120, 0.65)",
    backgroundColor: "rgba(18, 14, 12, 0.96)",
    marginRight: 6,
  },
  trackButtonText: { color: "#FFF3EA", fontSize: 14, fontWeight: "bold" },
  trackInfoGlass: {
    flex: 1,
    marginHorizontal: 6,
    paddingVertical: 6,
  ...
  trackLabel: { color: "rgba(255, 243, 234, 0.70)", fontSize: 11, marginRight: 6 },
  trackTitle: { color: "#FFF3EA", fontSize: 13, fontWeight: "700" },

  musicButton: {
    backgroundColor: "rgba(28, 14, 10, 0.95)",
    paddingHorizontal: 16,
    paddingVertical: 9,
    borderRadius: 999,
    marginHorizontal: 4,
    borderWidth: 1,
    borderColor: "rgba(255, 140, 60, 0.90)",
  },
  musicButtonSecondary: {
    backgroundColor: "rgba(16, 12, 10, 0.92)",
    paddingHorizontal: 16,
    paddingVertical: 9,
    borderRadius: 999,
    marginHorizontal: 4,
    borderWidth: 1,
    borderColor: "rgba(255, 203, 140, 0.65)",
  },
  musicButtonDisabled: { opacity: 0.55 },
  musicButtonText: { color: "#FFF3EA", fontWeight: "bold", fontSize: 13 },
  musicButtonTextSecondary: { color: "#FFE7D4", fontWeight: "bold", fontSize: 13 },
  ...
  backButton: {
    ...
    borderWidth: 1,
    borderColor: "rgba(255, 140, 60, 0.80)",
    marginRight: 10,
  },
  backButtonText: { fontSize: 22, color: "#FFF3EA" },
  headerGlass: {
    flex: 1,
    paddingVertical: 10,
    paddingHorizontal: 16,
    ...
    borderWidth: 1,
    borderColor: "rgba(255, 185, 120, 0.40)",
    shadowColor: "#FF8C3C",
    shadowOpacity: 0.45,
    shadowRadius: 18,
  ...
  section: {
    ...
    paddingHorizontal: 10,
    borderRadius: 20,
    backgroundColor: "rgba(16, 12, 10, 0.93)",
    borderWidth: 1,
  ...
  sectionDivider: {
    ...
    height: 2,
    borderRadius: 999,
    backgroundColor: "rgba(255, 140, 60, 0.90)",
  },
  ...
  aboutSection: {
    ...
    backgroundColor: "rgba(14, 10, 8, 0.96)",
    borderWidth: 1,
    borderColor: "rgba(255, 185, 120, 0.35)",
    shadowColor: "#FF8C3C",
    shadowOpacity: 0.25,
    shadowRadius: 22,
