// HarbingerDoveScreen.js (dull gray + red, same structure as your themed villain screens)
...
// ✅ TEMP: Use Sable tracks so nothing breaks until you add Harbinger Dove audio.
const TRACKS = [
  {
    id: "sable_main",
    label: "Sable Theme",
  ...
  const loadAndPlayTrack = useCallback(
    async (index) => {
      ...
      try {
        ...
        console.error("Failed to play Harbinger Dove track", e);
        setIsPlaying(false);
      }
    },
      ...
      <View style={styles.overlay}>
        ...
        <ScrollView contentContainerStyle={styles.scrollContainer}>
          ...
          <View style={styles.headerOuter}>
            <View style={styles.headerContainer}>
              ...
              <View style={styles.headerGlass}>
                <Text style={styles.title}>Harbinger Dove</Text>
                <Text style={styles.subtitle}>Fallen Angel • Betrayal • Vengeance</Text>
              </View>
            </View>
          </View>
          ...
          <View style={styles.section}>
            <Text style={styles.sectionTitle}>Crimson Wing Gallery</Text>
          ...
          <View style={styles.aboutSection}>
            ...
            <Text style={styles.aboutText}>
              Nemesis: <Text style={{ fontWeight: "900", color: "rgba(255, 49, 49, 0.95)" }}>Kintsunera</Text>
            </Text>

            <Text style={styles.aboutText}>
              Once a pacifist, Dove was betrayed by her ideals and became a weapon of vengeance. Dull silver armor
              and crimson wings mark a fallen protector—one who traded hope for retribution.
            </Text>

            <Text style={styles.aboutText}>
              Powers: mechanical wings with feather-like blades that launch, regenerate, and cut in wide arcs.
            </Text>

            <Text style={styles.aboutText}>
              Weapon: a spear of red energy that slices through most metals—an anti-angel lance against a guardian aura.
            </Text>
          </View>
        </ScrollView>
      </View>
...
const styles = StyleSheet.create({
  ...
  // ✅ HARBRINGER DOVE COLORS: dull gray + red
  musicControls: {
    flexDirection: "row",
    alignItems: "center",
    paddingVertical: 10,
    paddingHorizontal: 10,
    backgroundColor: "rgba(18, 18, 20, 0.95)", // dull graphite
    borderBottomWidth: 1,
    borderBottomColor: "rgba(255, 49, 49, 0.32)",
    shadowColor: "#FF3131",
    shadowOpacity: 0.4,
  ...
  trackButtonText: { color: "#EDEDEF", fontSize: 14, fontWeight: "bold" },
  trackInfoGlass: {
    flex: 1,
    marginHorizontal: 6,
    paddingVertical: 6,
  ...
  trackLabel: { color: "rgba(237, 237, 239, 0.75)", fontSize: 11, marginRight: 6 },
  trackTitle: { color: "#EDEDEF", fontSize: 13, fontWeight: "700" },

  musicButton: {
    backgroundColor: "rgba(34, 18, 18, 0.95)",
  ...
  musicButtonSecondary: {
    ...
    marginHorizontal: 4,
    borderWidth: 1,
    borderColor: "rgba(255, 49, 49, 0.60)",
  },
  musicButtonDisabled: { opacity: 0.55 },
  musicButtonText: { color: "#EDEDEF", fontWeight: "bold", fontSize: 13 },
  musicButtonTextSecondary: { color: "#EDEDEF", fontWeight: "bold", fontSize: 13 },
  ...
  backButtonText: { fontSize: 22, color: "#EDEDEF" },
  headerGlass: {
    flex: 1,
    paddingVertical: 10,
    paddingHorizontal: 16,
  ...
  section: {
    ...
    borderWidth: 1,
    borderColor: "rgba(255, 49, 49, 0.32)",
    shadowColor: "#FF3131",
    shadowOpacity: 0.25,
    shadowRadius: 18,
