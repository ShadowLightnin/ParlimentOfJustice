// ByteRuinScreen.js (black + neon “glitch” cyan/green, same structure as your themed villain screens)
...
// ✅ TEMP: Use Sable tracks so nothing breaks until you add Byte Ruin audio.
const TRACKS = [
  {
    id: "sable_main",
    label: "Sable Theme",
...
export default function ByteRuinScreen() {
  ...
  const loadAndPlayTrack = useCallback(
    async (index) => {
      ...
      try {
        ...
        console.error("Failed to play Byte Ruin track", e);
        setIsPlaying(false);
      }
    },
      ...
      <View style={styles.overlay}>
        ...
        <ScrollView contentContainerStyle={styles.scrollContainer}>
          ...
          <View style={styles.headerOuter}>
            <View style={styles.headerContainer}>
              ...
              <View style={styles.headerGlass}>
                <Text style={styles.title}>Byte Ruin</Text>
                <Text style={styles.subtitle}>Corruption • Overlord • System Collapse</Text>
              </View>
            </View>
          </View>
          ...
          <View style={styles.section}>
            <Text style={styles.sectionTitle}>Glitch Gallery</Text>
          ...
          <View style={styles.aboutSection}>
            ...
            <Text style={styles.aboutText}>
              Once a renowned programmer and inventor, Lucian Xian created a corruptive AI that gained self-awareness
              and bonded with him—transforming him into Byte Ruin, a digital overlord bent on subjugation.
            </Text>

            <Text style={styles.aboutText}>
              Abilities: Digital Corruption (tech takeover), Signal Jammer (comms disruption), Hardlight Constructs
              (traps/captures).
            </Text>

            <Text style={styles.aboutText}>
              Weapon: a digital whip that latches onto tech, destabilizing shields and devices mid-fight.
            </Text>
          </View>
        </ScrollView>
      </View>
...
const styles = StyleSheet.create({
  ...
  // ✅ BYTE RUIN COLORS: black + neon cyan/green
  musicControls: {
    flexDirection: "row",
    alignItems: "center",
    paddingVertical: 10,
