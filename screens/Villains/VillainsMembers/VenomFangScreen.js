// VenomFangScreen.js (black + green, same structure as your Fjord/Harbinger)
...
// ✅ TEMP: Use Sable tracks so nothing breaks until you add Venom Fang audio.
const TRACKS = [
  {
    id: "sable_main",
    label: "Sable Theme",
...
export default function VenomFangScreen() {
  ...
  const loadAndPlayTrack = useCallback(
    async (index) => {
      ...
      try {
        ...
        console.error("Failed to play Venom Fang track", e);
        setIsPlaying(false);
      }
    },
      ...
      <View style={styles.overlay}>
        ...
        <ScrollView contentContainerStyle={styles.scrollContainer}>
          ...
          <View style={styles.headerOuter}>
            <View style={styles.headerContainer}>
              ...
              <View style={styles.headerGlass}>
                <Text style={styles.title}>Venom Fang</Text>
                <Text style={styles.subtitle}>Venom • Instinct • Predation</Text>
              </View>
            </View>
          </View>
          ...
          <View style={styles.section}>
            <Text style={styles.sectionTitle}>Venom Gallery</Text>
          ...
          <View style={styles.aboutSection}>
            ...
            <Text style={styles.aboutText}>
              A brilliant scientist turned mercenary, Venom Fang studied spiders to engineer venom-based weaponry.
              He mirrors Nuscis’s agility—but twists it into poison, predation, and survival at any cost.
            </Text>

            <Text style={styles.aboutText}>
              Powers: enhanced agility and reflexes, poison-infused strikes and toxic delivery systems.
            </Text>

            <Text style={styles.aboutText}>
              Weapon: retractable mask fangs that vent toxic gas, plus clawed gauntlets that inject poison on contact.
            </Text>
          </View>
        </ScrollView>
      </View>
...
const styles = StyleSheet.create({
  ...
  musicControls: {
    ...
    borderBottomWidth: 1,
    borderBottomColor: "rgba(64, 255, 160, 0.30)",
    shadowColor: "#40FFA0",
    shadowOpacity: 0.4,
  ...
  trackButton: {
    ...
    borderRadius: 999,
    borderWidth: 1,
    borderColor: "rgba(64, 255, 160, 0.85)",
    backgroundColor: "rgba(8, 14, 12, 0.96)",
    marginRight: 6,
  },
  trackButtonText: { color: "#E9FFF6", fontSize: 14, fontWeight: "bold" },
  trackInfoGlass: {
    flex: 1,
    marginHorizontal: 6,
    paddingVertical: 6,
    ...
    borderWidth: 1,
    borderColor: "rgba(64, 255, 160, 0.55)",
    flexDirection: "row",
    alignItems: "center",
  },
  trackLabel: { color: "rgba(233, 255, 246, 0.75)", fontSize: 11, marginRight: 6 },
  trackTitle: { color: "#E9FFF6", fontSize: 13, fontWeight: "700" },
  ...
  musicButton: {
    ...
    marginHorizontal: 4,
    borderWidth: 1,
    borderColor: "rgba(64, 255, 160, 0.90)",
  },
  musicButtonSecondary: {
    backgroundColor: "rgba(6, 12, 10, 0.90)",
    paddingHorizontal: 16,
    paddingVertical: 9,
    borderRadius: 999,
    marginHorizontal: 4,
    borderWidth: 1,
    borderColor: "rgba(64, 255, 160, 0.65)",
  },
  musicButtonDisabled: { opacity: 0.55 },
  musicButtonText: { color: "#E9FFF6", fontWeight: "bold", fontSize: 13 },
  musicButtonTextSecondary: { color: "#E9FFF6", fontWeight: "bold", fontSize: 13 },
  ...
  backButtonText: { fontSize: 22, color: "#E9FFF6" },
  headerGlass: {
    flex: 1,
    paddingVertical: 10,
    paddingHorizontal: 16,
    borderRadius: 20,
    backgroundColor: "rgba(10, 18, 14, 0.90)",
    borderWidth: 1,
    borderColor: "rgba(64, 255, 160, 0.55)",
    shadowColor: "#40FFA0",
    shadowOpacity: 0.45,
  ...
  section: {
    ...
    paddingHorizontal: 10,
    borderRadius: 20,
    backgroundColor: "rgba(8, 16, 12, 0.93)",
    borderWidth: 1,
    borderColor: "rgba(64, 255, 160, 0.35)",
    shadowColor: "#40FFA0",
    shadowOpacity: 0.25,
    shadowRadius: 18,
  ...
  sectionDivider: {
    ...
    height: 2,
    borderRadius: 999,
    backgroundColor: "rgba(64, 255, 160, 0.85)",
  },
  ...
  card: (isDesktop, w) => ({
    ...
    overflow: "hidden",
    marginRight: 18,
    backgroundColor: "rgba(4, 10, 8, 0.90)",
    borderWidth: 1,
    borderColor: "rgba(64, 255, 160, 0.85)",
    shadowColor: "#40FFA0",
    shadowOpacity: 0.7,
  ...
  aboutSection: {
    ...
    borderWidth: 1,
    borderColor: "rgba(64, 255, 160, 0.45)",
    shadowColor: "#40FFA0",
    shadowOpacity: 0.25,
    shadowRadius: 22,
