...
const TRACKS = [
  {
    id: "virus_vortex_main",
    label: "Contamination Spiral",
    source: require("../../../assets/audio/sableEvilish.m4a"),
  },
  {
    id: "virus_vortex_alt",
    label: "Radiant Decay Mix",
    source: require("../../../assets/audio/sableEvilish.m4a"),
  },
];
...
const characters = [
  {
    name: "Virus Vortex",
    image: require("../../../assets/Villains/VirusVortex2.jpg"),
    clickable: true,
  },
  {
    name: "Virus Vortex (Family Friendly)",
    image: require("../../../assets/Villains/VirusVortex.jpg"),
    clickable: true,
  },
];

export default function VirusVortexScreen() {
  ...
  const loadAndPlayTrack = useCallback(
    async (index) => {
      ...
      try {
        ...
        console.error("Failed to play Virus Vortex track", e);
        setIsPlaying(false);
      }
    },
      ...
      <View style={styles.overlay}>
        ...
        <ScrollView contentContainerStyle={styles.scrollContainer}>
          ...
          <View style={styles.headerOuter}>
            <View style={styles.headerContainer}>
              ...
              <View style={styles.headerGlass}>
                <Text style={styles.title}>Virus Vortex</Text>
                <Text style={styles.subtitle}>
                  Contamination • Panic • Chemical Collapse
                </Text>
              </View>
            </View>
          </View>
          ...
          <View style={styles.section}>
            <Text style={styles.sectionTitle}>Hazard Gallery</Text>
          ...
          <View style={styles.aboutSection}>
            ...
            <Text style={styles.aboutText}>
              Nemesis: <Text style={{ fontWeight: "900", color: "rgba(255, 49, 49, 0.95)" }}>Chemoshock</Text>
            </Text>

            <Text style={styles.aboutText}>
              Motivation: A rogue scientist who despises Ben’s disciplined engineering — pursuing chaos through poison,
              decay, and engineered panic.
            </Text>

            <Text style={styles.aboutText}>
              Powers: Toxic chemical manipulation — corrosive clouds that erode armor and destabilize breathing, vision,
              and judgment.
            </Text>

            <Text style={styles.aboutText}>
              Weapon: Poison-injector gauntlets designed to deliver lethal compounds through seams, vents, and impact points.
            </Text>
          </View>
        </ScrollView>
      </View>
...
const styles = StyleSheet.create({
  ...
  musicControls: {
    ...
    borderBottomWidth: 1,
    borderBottomColor: "rgba(124, 255, 58, 0.35)",
    shadowColor: "#7CFF3A",
    shadowOpacity: 0.35,
  ...
  trackButton: {
    ...
    borderRadius: 999,
    borderWidth: 1,
    borderColor: "rgba(124, 255, 58, 0.85)",
    backgroundColor: "rgba(12, 18, 12, 0.96)",
    marginRight: 6,
  },
  trackButtonText: { color: "#E9FFE0", fontSize: 14, fontWeight: "bold" },
  trackInfoGlass: {
    flex: 1,
    marginHorizontal: 6,
    paddingVertical: 6,
  ...
  trackLabel: { color: "rgba(233, 255, 224, 0.70)", fontSize: 11, marginRight: 6 },
  trackTitle: { color: "#E9FFE0", fontSize: 13, fontWeight: "700" },
  musicButton: {
    backgroundColor: "rgba(12, 22, 12, 0.95)",
    paddingHorizontal: 16,
    paddingVertical: 9,
    borderRadius: 999,
    marginHorizontal: 4,
    borderWidth: 1,
    borderColor: "rgba(124, 255, 58, 0.9)",
  },
  musicButtonSecondary: {
    backgroundColor: "rgba(10, 14, 10, 0.90)",
    paddingHorizontal: 16,
    paddingVertical: 9,
    borderRadius: 999,
    marginHorizontal: 4,
  ...
  musicText: { color: "#E9FFE0", fontWeight: "bold", fontSize: 13 },
  ...
  backButton: {
    ...
    borderWidth: 1,
    borderColor: "rgba(124, 255, 58, 0.75)",
    marginRight: 10,
  },
  backButtonText: { fontSize: 22, color: "#E9FFE0" },
  headerGlass: {
    flex: 1,
    paddingVertical: 10,
    paddingHorizontal: 16,
    borderRadius: 20,
    backgroundColor: "rgba(12, 16, 12, 0.92)",
    borderWidth: 1,
  ...
  sectionTitle: { fontSize: 18, fontWeight: "800", color: "#E9FFE0", textAlign: "center" },
  sectionDivider: {
    marginTop: 8,
    marginBottom: 10,
    alignSelf: "center",
    ...
    height: 2,
    borderRadius: 999,
    backgroundColor: "rgba(124, 255, 58, 0.9)",
  },
