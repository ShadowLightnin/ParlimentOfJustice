...
const TRACKS = [
  {
    id: "steel_juggernaut_main",
    label: "Iron Pressure",
    source: require("../../../assets/audio/sableEvilish.m4a"),
  },
  {
    id: "steel_juggernaut_alt",
    label: "Crush Protocol",
    source: require("../../../assets/audio/sableEvilish.m4a"),
  },
];
...
const characters = [
  {
    ...
    image: require("../../../assets/Villains/SteelJuggernaut.jpg"),
    clickable: true,
  },
];

export default function SteelJuggernautScreen() {
  ...
  const loadAndPlayTrack = useCallback(
    async (index) => {
      ...
      try {
        ...
        console.error("Failed to play Steel Juggernaut track", e);
        setIsPlaying(false);
      }
    },
      ...
      <View style={styles.overlay}>
        ...
        <ScrollView contentContainerStyle={styles.scrollContainer}>
          ...
          <View style={styles.headerOuter}>
            <View style={styles.headerContainer}>
              ...
              <View style={styles.headerGlass}>
                <Text style={styles.title}>Steel Juggernaut</Text>
                <Text style={styles.subtitle}>Ironhide • Hydraulic Force • Relentless Advance</Text>
              </View>
            </View>
          </View>
          ...
          <View style={styles.section}>
            <Text style={styles.sectionTitle}>Juggernaut Gallery</Text>
          ...
          <View style={styles.aboutSection}>
            ...
            <Text style={styles.aboutText}>
              Motivation: Desires a rematch against Cruiser — convinced he is the ultimate soldier, and that Cole is the
              only rival worth breaking.
            </Text>

            <Text style={styles.aboutText}>
              Powers: Enhanced durability and brute strength that can match — and sometimes overwhelm — Cruiser’s combat
              speed through sheer mass and impact tolerance.
            </Text>

            <Text style={styles.aboutText}>
              Weapon: Hydraulic gauntlets engineered to crush armor plates and buckle joints under sustained pressure.
            </Text>
          </View>
        </ScrollView>
      </View>
...
const styles = StyleSheet.create({
  ...
  musicControls: {
    ...
    borderBottomWidth: 1,
    borderBottomColor: "rgba(185, 192, 199, 0.35)",
    shadowColor: "#B9C0C7",
    shadowOpacity: 0.35,
  ...
  trackButton: {
    ...
    borderRadius: 999,
    borderWidth: 1,
    borderColor: "rgba(185, 192, 199, 0.85)",
    backgroundColor: "rgba(14, 16, 18, 0.96)",
    marginRight: 6,
  },
  trackButtonText: { color: "#F2F4F6", fontSize: 14, fontWeight: "bold" },
  trackInfoGlass: {
    flex: 1,
    marginHorizontal: 6,
    paddingVertical: 6,
    paddingHorizontal: 10,
    borderRadius: 999,
    backgroundColor: "rgba(12, 14, 16, 0.96)",
    borderWidth: 1,
    borderColor: "rgba(185, 192, 199, 0.55)",
    flexDirection: "row",
    alignItems: "center",
  },
  trackLabel: { color: "rgba(242, 244, 246, 0.70)", fontSize: 11, marginRight: 6 },
  trackTitle: { color: "#F2F4F6", fontSize: 13, fontWeight: "700" },
  musicButton: {
    ...
    marginHorizontal: 4,
    borderWidth: 1,
    borderColor: "rgba(185, 192, 199, 0.9)",
  },
  ...
  musicText: { color: "#F2F4F6", fontWeight: "bold", fontSize: 13 },
  ...
  backButton: {
    ...
    borderWidth: 1,
    borderColor: "rgba(185, 192, 199, 0.75)",
    marginRight: 10,
  },
  backButtonText: { fontSize: 22, color: "#F2F4F6" },
  headerGlass: {
    flex: 1,
    paddingVertical: 10,
    paddingHorizontal: 16,
    ...
    borderWidth: 1,
    borderColor: "rgba(185, 192, 199, 0.35)",
    shadowColor: "#B9C0C7",
    shadowOpacity: 0.45,
    shadowRadius: 18,
  ...
  section: {
    ...
    borderWidth: 1,
    borderColor: "rgba(185, 192, 199, 0.25)",
  },
  sectionTitle: { fontSize: 18, fontWeight: "800", color: "#F2F4F6", textAlign: "center" },
  sectionDivider: {
    marginTop: 8,
    marginBottom: 10,
    alignSelf: "center",
    ...
    height: 2,
    borderRadius: 999,
    backgroundColor: "rgba(185, 192, 199, 0.9)",
  },
  ...
  aboutSection: {
    ...
    borderWidth: 1,
    borderColor: "rgba(185, 192, 199, 0.28)",
  },
  aboutHeader: {
    fontSize: 20,
    fontWeight: "900",
