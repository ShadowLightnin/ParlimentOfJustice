...
const TRACKS = [
  {
    id: "overmind_main",
    label: "Cold Logic Ascendant",
    source: require("../../../assets/audio/sableEvilish.m4a"),
  },
  {
    id: "overmind_alt",
    label: "Neural Crown Protocol",
    source: require("../../../assets/audio/sableEvilish.m4a"),
  },
];
...
const characters = [
  {
    name: "Overmind",
    image: require("../../../assets/Villains/Overmind.jpg"),
    clickable: true,
  },
];

export default function OvermindScreen() {
  ...
  const loadAndPlayTrack = useCallback(
    async (index) => {
      ...
      try {
        ...
        console.error("Failed to play Overmind track", e);
        setIsPlaying(false);
      }
    },
      ...
      <View style={styles.overlay}>
        ...
        <ScrollView contentContainerStyle={styles.scrollContainer}>
          ...
          <View style={styles.headerOuter}>
            <View style={styles.headerContainer}>
              ...
              <View style={styles.headerGlass}>
                <Text style={styles.title}>Overmind</Text>
                <Text style={styles.subtitle}>Cold Logic • Total Control • Machine Dominion</Text>
              </View>
            </View>
          </View>
          ...
          <View style={styles.section}>
            <Text style={styles.sectionTitle}>Overmind Gallery</Text>
          ...
          <View style={styles.aboutSection}>
            ...
            <Text style={styles.aboutText}>
              Motivation: Despises Joseph’s ingenuity — convinced Techoman is an inferior mind that must be broken so a
              new technocratic era can rise under a single perfect intellect.
            </Text>

            <Text style={styles.aboutText}>
              Powers: Advanced technopathy — hijacks machines through thought alone, corrupts signals, and turns
              Techoman’s own systems into liabilities mid-fight.
            </Text>

            <Text style={styles.aboutText}>
              Weapon: A staff that emits focused EMP pulses — designed to short nearby tech instantly and “silence”
              enemy hardware in a tight radius.
            </Text>
          </View>
        </ScrollView>
      </View>
...
const styles = StyleSheet.create({
  ...
  musicControls: {
    ...
    borderBottomWidth: 1,
    borderBottomColor: "rgba(207, 233, 255, 0.35)",
    shadowColor: "#CFE9FF",
    shadowOpacity: 0.35,
  ...
  trackButton: {
    ...
    borderRadius: 999,
    borderWidth: 1,
    borderColor: "rgba(207, 233, 255, 0.85)",
    backgroundColor: "rgba(12, 14, 18, 0.96)",
    marginRight: 6,
  },
  trackButtonText: { color: "#EEF8FF", fontSize: 14, fontWeight: "bold" },
  trackInfoGlass: {
    flex: 1,
    marginHorizontal: 6,
    paddingVertical: 6,
    ...
    backgroundColor: "rgba(12, 14, 18, 0.96)",
    borderWidth: 1,
    borderColor: "rgba(207, 233, 255, 0.55)",
    flexDirection: "row",
    alignItems: "center",
  },
  trackLabel: { color: "rgba(238, 248, 255, 0.70)", fontSize: 11, marginRight: 6 },
  trackTitle: { color: "#EEF8FF", fontSize: 13, fontWeight: "700" },
  musicButton: {
    ...
    marginHorizontal: 4,
    borderWidth: 1,
    borderColor: "rgba(207, 233, 255, 0.9)",
  },
  ...
  musicText: { color: "#EEF8FF", fontWeight: "bold", fontSize: 13 },
  ...
  backButton: {
    ...
    borderWidth: 1,
    borderColor: "rgba(207, 233, 255, 0.75)",
    marginRight: 10,
  },
  backButtonText: { fontSize: 22, color: "#EEF8FF" },
  headerGlass: {
    flex: 1,
    paddingVertical: 10,
    paddingHorizontal: 16,
    ...
    borderWidth: 1,
    borderColor: "rgba(207, 233, 255, 0.35)",
    shadowColor: "#CFE9FF",
    shadowOpacity: 0.45,
    shadowRadius: 18,
  ...
  section: {
    ...
    borderWidth: 1,
    borderColor: "rgba(207, 233, 255, 0.25)",
  },
  sectionTitle: { fontSize: 18, fontWeight: "800", color: "#EEF8FF", textAlign: "center" },
  sectionDivider: {
    marginTop: 8,
    marginBottom: 10,
    alignSelf: "center",
    ...
    height: 2,
    borderRadius: 999,
    backgroundColor: "rgba(207, 233, 255, 0.9)",
  },
