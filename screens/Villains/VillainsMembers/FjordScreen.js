...
// ✅ TEMP: Use Sable tracks so nothing breaks until you add Fjord audio.
...
export default function FjordScreen() {
  ...
  const safeTracks = Array.isArray(TRACKS) && TRACKS.length > 0
    ? TRACKS
  ...
  const loadAndPlayTrack = useCallback(
    async (index) => {
      ...
      try {
        ...
        console.error("Failed to play Fjord track", e);
        setIsPlaying(false);
      }
    },
      ...
      <View style={styles.overlay}>
        ...
        <ScrollView contentContainerStyle={styles.scrollContainer}>
          ...
          <View style={styles.headerOuter}>
            <View style={styles.headerContainer}>
              ...
              <View style={styles.headerGlass}>
                <Text style={styles.title}>Fjord</Text>
                <Text style={styles.subtitle}>Frost • Survival • Unrestrained Strength</Text>
              </View>
            </View>
          </View>
          ...
          <View style={styles.section}>
            <Text style={styles.sectionTitle}>Frost Gallery</Text>
          ...
          <View style={styles.aboutSection}>
            ...
            <Text style={styles.aboutText}>
              Fjord was once a mountain tribesman who revered nature’s harsh forces. Chosen as a vessel by an ancient glacier
              spirit, he gained dominion over ice and storm—at the cost of his humanity.
            </Text>

            <Text style={styles.aboutText}>
              Powers: super strength rivaling Annihilator, absolute frost control, localized blizzards, instant freezing,
              and ice shaping.
            </Text>

            <Text style={styles.aboutText}>
              Weapon: a heavy frost axe that emits freezing energy and fractures armor with glacial shock.
            </Text>
          </View>
        </ScrollView>
      </View>
...
const styles = StyleSheet.create({
  ...
  trackButtonText: { color: "#e9fbff", fontSize: 14, fontWeight: "bold" },
  trackInfoGlass: {
    flex: 1,
    marginHorizontal: 6,
    paddingVertical: 6,
  ...
  trackLabel: { color: "#b8dfff", fontSize: 11, marginRight: 6 },
  trackTitle: { color: "#e9fbff", fontSize: 13, fontWeight: "700" },
  musicButton: {
  ...
  musicButtonText: { color: "#e9fbff", fontWeight: "bold", fontSize: 13 },
  musicButtonTextSecondary: { color: "#d6ecff", fontWeight: "bold", fontSize: 13 },
  ...
  backButtonText: { fontSize: 22, color: "#e8f4ff" },
  headerGlass: {
    flex: 1,
    paddingVertical: 10,
    paddingHorizontal: 16,
